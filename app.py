...
PORTFOLIO_ITEMS = [
    ...
    },
    {
        ...
        'description': 'Machine learning model to predict osteoporosis risk using clinical features (age, BMI, gender, lifestyle). Includes preprocessing, feature selection, and model comparisons (Logistic Regression, Random Forest, SVM).',
        'image': 'project4.svg',
        'technologies': ['Python', 'Scikit-learn', 'Pandas', 'NumPy', 'Matplotlib'],
        'repo': '#',
        'metrics': ['Random Forest accuracy ~80%', 'Feature importance analysis included'],
        'charts': ['project4_chart.svg'],
        'category': 'ml',
        'live_url': '#'
    },
    {
        ...
        'description': 'Time-series forecasting of cryptocurrency prices using Linear Regression, LSTM, Random Forest, and ARIMA with visualizations using Matplotlib/Seaborn.',
        'image': 'project5.svg',
        'technologies': ['Python', 'Pandas', 'NumPy', 'LSTM', 'ARIMA', 'Seaborn'],
        'repo': '#',
        'metrics': ['Implemented LSTM and ARIMA models', 'Time-series visualizations included'],
        'charts': ['project5_chart.svg'],
        'category': 'ml',
        'live_url': '#'
    }
]
...
SKILLS = {
    'Programming Languages': {'Java (Basics)': 60, 'C (Basics)': 60, 'Python': 70},
    'Web': {'HTML': 60, 'CSS': 50},
    'Databases': {'SQL': 50},
    'Tools & ML': {'Pandas': 65, 'NumPy': 65, 'Scikit-learn': 60, 'Matplotlib': 50, 'Seaborn': 50}
}
